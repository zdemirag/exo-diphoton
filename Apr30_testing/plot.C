void plot() {
  ...
  */
  ...
  TFile *file1 = new TFile("histograms_diphoton_tree_MC_all.root","READ");
  TFile *file2 = new TFile("histograms_ExoDiPhotonAnalyzer_LooseDataABCD2012_GammaJet.root","READ");
  TFile *file3 = new TFile("histograms_ExoDiPhotonAnalyzer_LooseDataABCD2012_JetJet.root","READ");
  TFile *file4 = new TFile("histograms_ExoDiPhotonAnalyzer_LooseDataABCD2012.root","READ");
  ...
  t->DrawLatex(0.65,0.65,"N_{MC} in range: 2498.6 Events ");
  t->DrawLatex(0.65,0.60,"N_{Fit} in range: 2493.4 Events ");
