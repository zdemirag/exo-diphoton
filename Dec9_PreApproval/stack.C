void stack() {
  ...
  TH1F *h1 = new TH1F("h1","h1",binning,lowEnd,highEnd);
  //h1->Sumw2();
  h1->SetFillColor(33);
  ...
  hs->Draw();
  hs->SetTitle("");
  hs->GetYaxis()->SetTitle("Events / 40 GeV");
  ...
  tex->SetLineWidth(2);
  tex->Draw();
  tex = new TLatex(0.87,0.95,"19.52 fb^{-1} (8 TeV)");
  tex->SetNDC();
  tex->SetTextAlign(31);
